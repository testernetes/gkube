...
func TestEqualObjectMatcher(t *testing.T) {
	tests := []struct {
		...
		options  []EqualObjectMatchOption
		want     bool
	}{
		...
		// Ignore fields MatchOption
		{
			...
			options: []EqualObjectMatchOption{IgnoreAutogeneratedMetadata},
			want:    true,
		},
		{
			...
			options: []EqualObjectMatchOption{IgnorePaths{{"metadata", "labels"}, {"metadata", "annotations"}}},
			want:    true,
		},
		{
			...
			options: []EqualObjectMatchOption{IgnorePaths{{"spec", "controlPlaneEndpoint"}}},
			want:    true,
		},
		...
		// AllowPaths MatchOption
		{
			...
			options: []EqualObjectMatchOption{AllowPaths{{"spec"}}},
			want:    true,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			g := NewWithT(t)
			matcher := NewEqualObjectMatcher(tt.original, tt.options...)
